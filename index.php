...
<header class="w3-display-container w3-center">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="<?php echo get_template_directory_uri(); ?>/images/app.jpg" alt="Image 1" style="min-width:500px" width="1500" height="1000">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="<?php echo get_template_directory_uri(); ?>/images/app2.jpg" alt="Image 2" style="min-width:500px" width="1500" height="1000">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="<?php echo get_template_directory_uri(); ?>/images/app4.jpg" alt="Image 3" style="min-width:500px" width="1500" height="1000">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
...
<div class="w3-padding-64 w3-white">
  <div class="w3-row-padding">
    ...
    <div class="w3-col l4 m6">
      <img src="<?php echo get_template_directory_uri(); ?>/images/img_app.jpg"" class="w3-image w3-right w3-hide-small" width="335" height="471">
...
<div class="w3-padding-64 w3-light-grey">
  <div class="w3-row-padding">
    <div class="w3-col l4 m6">
      <img class="w3-image w3-round-large w3-hide-small w3-grayscale" src="<?php echo get_template_directory_uri(); ?>/images/app5.jpg" alt="App" width="335" height="471">
    </div>
    <div class="w3-col l8 m6">
